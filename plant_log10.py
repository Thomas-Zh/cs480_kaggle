...
class PlantImgTrainDataset(Dataset):
    def __init__(self, transform=None, target_transform=None):
      # read the last 6 columns => traits
        ...
        self.plant_img_traits = np.log10(self.plant_img_traits)
...
def predict_and_save(model, dataloader, csv_path):
    ...
    unnormalized_predictions = np.power(10, unnormalized_predictions)
...
output_csv_path = '/Users/xiaofeizhang/cs680/kaggle/data/predictions_epoch2_resnet152_log10_p1_lr.csv'
# train_model(model_plant_trait_prediction, trainloader, criterion, optimizer, num_epochs=2)
# model_trained = torch.save(model_plant_trait_prediction.state_dict(),'/Users/xiaofeizhang/cs680/kaggle/trained_model_batch32_2_epoch_resnet152_log10_lrp1.pth')

model_loaded = PlantTraitPredictionCNN(num_traits)
model_loaded.to(device)
model_saved= torch.load('/Users/xiaofeizhang/cs680/kaggle/trained_model_batch32_2_epoch_resnet152_log10_lrp1.pth')
